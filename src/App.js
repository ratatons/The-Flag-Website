...
function App() {
  ...
  const handleSendEmail = (e) => {
    ...
    emailjs
      ...
      .then(() => {
        setSendStatus({ type: 'success', message: 'Message sent! We will get back to you soon.' });
        formRef.current.reset();
      })
      .catch(() => {
        setSendStatus({ type: 'error', message: 'There was a problem sending. Please try again.' });
      })
    ...
    <div className="App">
        ...
        <div className="who-content">
          <div className="who-card">
            <div className="who-text">
              <h2>Who We Are</h2>
              <p>Side Quest is run by people who are tired of watching lives get lost just because the right info isn’t out there. We’re bored, fed up, and honestly pissed that this keeps happening when it doesn’t have to.</p>
              <p>We're here to change that — no excuses, no waiting around. But we can't do it solo. We need you. 🏖️</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="contact-section" id="contact" ref={contactRef}>
        <div className="contact-container">
          ...
          <p className="contact-description">We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
      ...
      <section className="download-section">
        <div className="download-container">
          ...
          <p className="download-description">Get the best experience on mobile. Available now on iOS and Android.</p>
          
          <div className="download-buttons">
            <a href="#" className="store-button google-play" target="_blank" rel="noopener noreferrer">
            ...
            <a href="#" className="store-button app-store" target="_blank" rel="noopener noreferrer">
              <div className="button-content">
                <svg className="store-icon" viewBox="0 0 24 24" fill="currentColor">
